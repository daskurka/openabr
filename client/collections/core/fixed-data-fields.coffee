...
module.exports = Collection.extend
  ...
  addAbrReadingFields: () ->
    ...
    addField(@,'abr-reading','number','Duration','duration', yes,false,{unit: 'm', prefix: 's'},'ABR Reading duration.')
    addField(@,'abr-reading','number','Sample Rate','sampleRate', yes,true,{unit: 'm', prefix: 's'},'ABR Reading sample rate.')
    addField(@,'abr-reading','number','Number Samples','numberSamples', yes,true,null,'ABR Reading sample count.')
    addField(@,'abr-reading','number','Value Max','valueMax', yes,true,{unit: 'm', prefix: 'V'},'ABR Reading max amplitude.')
    addField(@,'abr-reading','number','Value Min','valueMin', yes,true,{unit: 'm', prefix: 'V'},'ABR Reading min amplitude.')
