(function (root, factory) {
    ...
    templatizer["pages"]["abrSets"]["remove"] = function tmpl_pages_abrSets_remove() {
        return '<div class="container"><div class="row"><h2><span data-hook="title">Remove ABR Set</span>&nbsp;<small data-hook="subtitle"></small></h2></div><div class="row"><h1>Warning!</h1><p>Clicking remove below will&nbsp;<strong><u>remove all related ABR readings!</u></strong></p><p>If you are sure you know what you are doing click remove below to proceed.</p></div><div class="row"><div class="btn-group"><button data-hook="cancel" type="button" class="btn btn-default">Cancel&nbsp;<span class="glyphicon glyphicon-step-backward"></span></button><button data-hook="remove" type="button" class="btn btn-danger">Remove&nbsp;<span class="glyphicon glyphicon-remove"></span></button></div></div></div>';
    };

    // pages\abrSets\view.jade compiled template
    templatizer["pages"]["abrSets"]["view"] = function tmpl_pages_abrSets_view() {
        return '<div class="container"><div class="row"><h2><span data-hook="title">ABR Set</span>&nbsp;<small data-hook="subtitle"></small></h2></div><div class="row"><div class="col-lg-8"><div class="row"><div data-hook="threshold-analysis-area"><p>threshold analysis tool?</p></div></div></div><div class="col-lg-4"><div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title">Actions</h4></div><div class="panel-body"><div class="btn-group btn-group-justified"><div class="btn-group"><button data-hook="edit" class="btn btn-primary">Edit Details</button></div><div class="btn-group"><button data-hook="remove" class="btn btn-warning">Remove</button></div></div></div></div><div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title">ABR Set Details</h4></div><div class="panel-body"><div data-hook="details"></div></div></div><div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title">ABR Readings</h4></div><div data-hook="readings-list-area" class="list-group"><p>readings list ghoes here</p></div></div></div></div></div>';
    };
    ...
    templatizer["pages"]["admin"]["fields"]["index"] = function tmpl_pages_admin_fields_index() {
        return '<div><h2>Fields Administration&nbsp;<small>Help</small></h2><ul class="nav nav-pills"><li role="presentation" class="active"><a href="/admin/fields">Help</a></li><li role="presentation"><a href="/admin/fields/subject">Subject</a></li><li role="presentation"><a href="/admin/fields/experiment">Experiment</a></li><li role="presentation"><a href="/admin/fields/abr-group">ABR Group</a></li><li role="presentation"><a href="/admin/fields/abr-set">ABR Set</a></li><li role="presentation"><a href="/admin/fields/abr-reading">ABR Reading</a></li></ul><h3>Overview</h3><p>Fields are the way of organising and storing meta-data. Each field represents a \'column\' in a traditional database sense. Not every record needs to have an entry for a field but if it does the definitions here help the system manage and deal with it.</p><h3>Subject, Experiment</h3><p>Subjects and Experiments can have any fields that you want. In the following tabs you can add, edit and delete fields for these.</p><h3>ABR Group, Set and Reading</h3><p>ABR Groups, Sets and Readings each share user-defined fields. Only the system can directly update an indiviudal record. This is done for faster and simplier indexing of records.</p></div>';
    };
    ...
    templatizer["pages"]["subjects"]["view"] = function tmpl_pages_subjects_view() {
        return '<div class="container"><div class="row"><h2><span data-hook="title"></span>&nbsp;<small data-hook="subtitle"></small></h2></div><div class="row"><div class="col-lg-8"><div data-hook="timeline" class="row"></div><hr/><div role="tabpanel" class="row"><ul role="tablist" id="graphTabs" class="nav nav-tabs"><li role="presentation" class="active"><a href="#threshold-analysis-tab" role="tab" data-toggle="tab">Subject Threshold Analysis</a></li><li role="presentation"><a href="#latency-analysis-tab" role="tab" data-toggle="tab">Subject Latency Analysis</a></li><li role="presentation"><a href="#group-view-tab" role="tab" data-toggle="tab">Group Snapshot</a></li></ul><div class="tab-content"><div id="threshold-analysis-tab" role="tabpanel" class="tab-pane active"><div class="panel panel-default panel-tab"><div class="panel-body"><div data-hook="threshold-analysis-graph"></div></div></div></div><div id="latency-analysis-tab" role="tabpanel" class="tab-pane"><div class="panel panel-default panel-tab"><div class="panel-body"><div data-hook="latency-analysis-graph"></div></div></div></div><div id="group-view-tab" role="tabpanel" class="tab-pane"><div class="panel panel-default panel-tab"><div class="panel-body"><div data-hook="group-show">Please select a group first.</div></div></div></div></div></div></div><div class="col-lg-4"><div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title">Actions</h4></div><div class="panel-body"><div class="btn-group btn-group-justified"><div class="btn-group"><button data-hook="edit" class="btn btn-primary">Edit Details</button></div><div class="btn-group"><button data-hook="remove" class="btn btn-warning">Remove</button></div></div></div></div><div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title">Subject Details</h4></div><div class="panel-body"><div data-hook="details"></div></div></div><div data-hook="experiments"></div></div></div></div>';
    };
    ...
    templatizer["pages"]["upload"]["reviewAndCommit"] = function tmpl_pages_upload_reviewAndCommit() {
        return '<div class="container"><h2>Upload ABR(s)&nbsp;<small>STEP 4: Review and Commit</small></h2><div class="row"><div class="col-md-6"><div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title">Tag Results</h4></div><div class="panel-body"><input data-hook="tag-selector" class="form-control"/></div></div><div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title">Attach Futher Meta-Data</h4></div><div class="panel-body"><p data-hook="form-area">loading...</p></div></div></div><div class="col-md-6"><div class="panel panel-default"><div class="panel-heading"><h4 class="panel-title">Review ABRs For Upload</h4></div><div class="panel-body"><p data-hook="review-area">loading...</p></div></div></div></div><div class="row"><div class="col-md-12"><div class="panel panel-default"><div class="panel-footer"><button data-hook="cancel" class="btn btn-default">Cancel</button>&nbsp;&nbsp;<button data-hook="next" class="btn btn-primary">Commit to Database<span class="glyphicon glyphicon-step-forward"></span></button></div></div></div></div><div tabindex="-1" role="dialog" aria-hidden="true" id="leaveModal" class="modal fade"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h4 class="modal-title">Are You Sure?</h4></div><div class="modal-body"><p>Any and all work done on importing this ABR will be lost. You will have to start the process from the beginning if you leave now.</p></div><div class="modal-footer"><button data-dismiss="modal" class="btn btn-default">No, take me back.</button><button id="modalQuit" class="btn btn-primary">Yes i\'m sure.</button></div></div></div></div></div>';
    };
    ...
    // views\upload\confirmFormView.jade compiled template
    templatizer["views"]["upload"]["confirmFormView"] = function tmpl_views_upload_confirmFormView() {
        return '<div><form data-hook="edit-form"><fieldset data-hook="field-container"></fieldset></form><h4>Include Other Fields</h4><div id="fieldArea"></div></div>';
    };

    // views\upload\confirmReviewView.jade compiled template
    templatizer["views"]["upload"]["confirmReviewView"] = function tmpl_views_upload_confirmReviewView() {
        return '<div id="quick-details"></div>';
    };
