...
(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><nav class="navbar navbar-default navbar-inverse"><div class="container-fluid"><div class="navbar-header"><a href="/" class="navbar-brand">OpenABR</a></div><ul class="nav navbar-nav"><li><a href="/">Home</a></li><li><a href="/about">About</a></li><li><a href="/login">Login</a></li></ul></div></nav><div class="container"><main data-hook="page-container"></main></div></body>';
    };
    ...
    templatizer["test"] = function tmpl_test(locals) {
        ...
        (function(squid) {
            buf.push('<div id="yes" class="hello">YOU</div><div class="mouse">' + jade.escape((jade_interp = squid) == null ? "" : jade_interp) + '</div><p class="test">hi</p>');
        }).call(this, "squid" in locals_for_with ? locals_for_with.squid : typeof squid !== "undefined" ? squid : undefined);
        return buf.join("");
    };
...
(function() {
  var OpenAbrRouter, Router, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  Router = require('ampersand-router');

  OpenAbrRouter = (function(_super) {
    __extends(OpenAbrRouter, _super);

    function OpenAbrRouter() {
      _ref = OpenAbrRouter.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    OpenAbrRouter.prototype.routes = {
      '': 'home',
      'about': 'about',
      'login': 'login'
    };

    OpenAbrRouter.prototype.home = function() {
      return console.log('home route');
    };

    OpenAbrRouter.prototype.about = function() {
      return console.log('about route');
    };

    OpenAbrRouter.prototype.login = function() {
      return console.log('login route');
    };

    return OpenAbrRouter;
...
},{"ampersand-router":4}],5:[function(require,module,exports){
(function() {
  var $, MainView, Router, domReady, templates;
...
},{"./views/main.coffee":6,"./router.coffee":3,"./templates":1,"jquery":7,"domready":8}],8:[function(require,module,exports){
/*!
...
(function() {
  var MainView, View, ViewSwitcher, templates, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.template = templates.body;
    ...
    MainView.prototype.handleLinkClick = function() {
      return console.log('link click hit');
    };

    MainView.prototype.handleNewPage = function(view) {
...
},{"../templates":1,"ampersand-view-switcher":9,"ampersand-view":10}],9:[function(require,module,exports){
/*$AMPERSAND_VERSION*/
...
},{"./ampersand-history":14,"underscore":15,"ampersand-class-extend":16,"backbone-events-standalone":17}],18:[function(require,module,exports){
'use strict';
...
},{"ampersand-collection-view":19,"domify":11,"underscore":12,"ampersand-dom-bindings":20,"get-object-path":13,"matches-selector":18,"ampersand-state":21}],15:[function(require,module,exports){
(function(){//     Underscore.js 1.6.0
//     http://underscorejs.org
//     (c) 2009-2014 Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
//     Underscore may be freely distributed under the MIT license.
...
},{"underscore":15,"backbone-events-standalone":17}],17:[function(require,module,exports){
module.exports = require('./backbone-events-standalone');

},{"./backbone-events-standalone":22}],16:[function(require,module,exports){
...
},{"extend-object":23}],22:[function(require,module,exports){
(function(){/**
...
},{"ampersand-class-extend":25,"backbone-events-standalone":26,"underscore":12}],27:[function(require,module,exports){
...
},{"ampersand-dom":24,"key-tree-store":27,"matches-selector":18}],21:[function(require,module,exports){
/*$AMPERSAND_VERSION*/
var _ = require('underscore');
var BBEvents = require('backbone-events-standalone');
...
},{"underscore":28,"array-next":29,"backbone-events-standalone":30,"key-tree-store":31}],26:[function(require,module,exports){
module.exports = require('./backbone-events-standalone');

},{"./backbone-events-standalone":32}],29:[function(require,module,exports){
...
},{"extend-object":33}],30:[function(require,module,exports){
module.exports = require('./backbone-events-standalone');

},{"./backbone-events-standalone":34}],33:[function(require,module,exports){
var arr = [];
var each = arr.forEach;
var slice = arr.slice;
