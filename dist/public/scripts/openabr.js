...
},{"./base.coffee":4}],5:[function(require,module,exports){
(function() {
  var Account;
...
},{"../admin/account.coffee":6}],7:[function(require,module,exports){
(function() {
  var User;
...
},{"../user.coffee":3}],8:[function(require,module,exports){
(function() {
  var User;
  ...
  module.exports = User.extend({
    ...
    urlRoot: function() {
      return "/api/" + this.accountUrl + "/users";
    },
    session: {
      accountUrl: {
        type: 'string',
...
},{"../user.coffee":3}],6:[function(require,module,exports){
(function() {
  var Base;
...
},{"./base.coffee":10,"../templates":1}],11:[function(require,module,exports){
(function() {
  var PageView, templates;
...
},{"./base.coffee":10,"../templates":1}],12:[function(require,module,exports){
(function() {
  var PageView, templates;
...
},{"./base.coffee":10,"../templates":1}],13:[function(require,module,exports){
(function() {
  var PageView, templates;
  ...
  module.exports = PageView.extend({
    ...
    submit: function(event) {
      ...
      return app.login(email, pass, rmbr, function(err, correct) {
        if (err != null) {
          return console.log("Error logging in: " + err);
        }
        if (!correct) {
          return $('#failedLoginAlert').removeClass('hidden');
        }
      });
    }
  });
...
},{"./base.coffee":10,"../templates":1}],14:[function(require,module,exports){
(function() {
  var PageView, templates;
...
},{"./base.coffee":10,"../templates":1}],15:[function(require,module,exports){
(function() {
  var PageView, templates;
  ...
  module.exports = PageView.extend({
    ...
    newAccount: function() {
      return app.navigate('admin/accounts/create');
    },
    filterAccounts: function() {
      return console.log('filter accounts hit');
    }
  });
...
},{"../../base.coffee":10,"../../../templates":1}],16:[function(require,module,exports){
(function() {
  var PageView, templates;
...
},{"../../base.coffee":10,"../../../templates":1}],17:[function(require,module,exports){
(function() {
  var PageView, templates;
...
},{"../../base.coffee":10,"../../../templates":1}],18:[function(require,module,exports){
(function(){(function() {
  var AboutPage, AdminAccountCreate, AdminAccountsPage, AdminUsersPage, ContactPage, FourOhFourPage, HomePage, LoginPage, Router;
  ...
  module.exports = Router.extend({
    ...
    home: function() {
      return this.trigger('page', new HomePage());
    },
    about: function() {
      return this.trigger('page', new AboutPage());
    },
    contact: function() {
      return this.trigger('page', new ContactPage());
    },
    login: function() {
      return this.trigger('page', new LoginPage());
    },
    logout: function() {
      return app.logout();
    },
    profile: function() {
      return console.log('user profile hit');
    },
    adminAccounts: function() {
      return this.trigger('page', new AdminAccountsPage());
    },
    adminAccountCreate: function() {
      return this.trigger('page', new AdminAccountCreate());
    },
    adminUsers: function() {
      return this.trigger('page', new AdminUsersPage());
    },
    accountHome: function(accountName) {
      console.log("Account home route for " + accountName + " hit...");
      return false;
    },
    accountProcess: function(accountName) {
      return console.log("Account process route for " + accountName + " hit...");
    },
    accountQuery: function(accountName) {
      return console.log("Account query route for " + accountName + " hit...");
    },
    accountExperiments: function(accountName) {
      return console.log("Account experiments route for " + accountName + " hit...");
    },
    accountSubjects: function(accountName) {
      return console.log("Account subjects route for " + accountName + " hit...");
    },
    catchAll: function() {
      return this.trigger('page', new FourOhFourPage());
    }
  });
...
},{"./pages/home.coffee":12,"./pages/about.coffee":11,"./pages/login.coffee":13,"./pages/contact.coffee":14,"./pages/404.coffee":9,"./pages/admin/accounts/accounts.coffee":15,"./pages/admin/accounts/create.coffee":16,"./pages/admin/users/users.coffee":17,"ampersand-router":19}],20:[function(require,module,exports){
(function() {
  var Cookies, Current, MainView, Router, bootstrap, configureAjax, domReady, templates;
  ...
  module.exports = {
    start: function() {
      ...
      return domReady(function() {
        ...
        _this.me = new Current();
        _this.view = new MainView({
          el: document.body
        });
        _this.view.render();
        _this.router.history.start({
          pushState: true,
          root: '/'
        });
        if (Cookies.enabled && Cookies.get('rememberMe')) {
          app.serverToken = Cookies.get('serverToken');
          userId = Cookies.get('userId');
          if ((app.serverToken != null) && (userId != null)) {
            return _this.me.loginUserId(userId, function(err) {
              if (err != null) {
                return _this.logout();
              }
              _this.view.trigger('login');
              if (window.location.length <= 0) {
                return app.navigate(_this.me.currentAccount.urlName);
              }
            });
          } else {
            return console.log('Malformed token/userId - cannot login automatically.');
          }
        }
      });
    },
    ...
    login: function(email, password, remember, callback) {
      ...
      return $.ajax({
        ...
        success: function(response) {
          ...
          return _this.me.login(response.user, response.isSystemAdmin, function(err) {
            if (err != null) {
              _this.me.logout();
              return callback(err);
            } else {
              _this.view.trigger('login');
              app.navigate(_this.me.currentAccount.urlName);
  ...
  configureAjax = function() {
    $(document).ajaxSend(function(event, request, options) {
      ...
      if (token != null) {
        return request.setRequestHeader('token', token);
      }
    });
    return $(document).ajaxError(function(event, response) {
      if (response.status === 401) {
...
},{"./router.coffee":18,"./models/current.coffee":21,"./views/main.coffee":22,"./templates":1,"cookies-js":23,"domready":24,"jquery":25,"bootstrap":26}],24:[function(require,module,exports){
/*!
...
},{"ampersand-model":27}],21:[function(require,module,exports){
(function() {
  var Account, Collection, OtherAccountsCollection, State, User;
  ...
  OtherAccountsCollection = Collection.extend({
    ...
    url: function() {
      return "/api/profile/" + this.userId + "/accounts";
    },
    model: Account,
    userId: null
  });
  ...
  module.exports = State.extend({
    ...
    login: function(user, isSysAdmin, callback) {
      var _this = this;
      this.user = user;
      this.otherAccounts = new OtherAccountsCollection();
      this.otherAccounts.userId = this.user.id;
      return this.otherAccounts.fetch({
        success: function(collection, response, options) {
          _this.currentAccount = collection.first();
          _this.isLoggedIn = true;
          _this.isSystemAdmin = isSysAdmin;
          return callback(null);
        },
        error: function(collection, response, options) {
          return callback('Error fetching accounts!');
        }
      });
    },
    loginUserId: function(userId, callback) {
      var u,
        _this = this;
      u = new User();
      u.id = userId;
      return u.fetch({
        success: function(user, response, options) {
          return _this.login(user, response.isSystemAdmin, callback);
        },
        error: function(user, response, options) {
          return callback('Error fetching user!');
        }
      });
    },
    logout: function() {
      ...
      return this.isSystemAdmin = false;
    }
  });
...
},{"./user.coffee":3,"./account/account.coffee":5,"ampersand-state":28,"ampersand-rest-collection":29}],30:[function(require,module,exports){
(function() {
  var View, templates;
  ...
  module.exports = View.extend({
    ...
    initialize: function() {
      this.listenTo(app.view, 'login', this.logon);
      return this.listenTo(app.view, 'logout', this.logoff);
    },
    render: function() {
    ...
    logoff: function() {
      return this.query('.navbar-content').innerHTML = templates.includes.navbar.loggedout();
    },
    logon: function() {
      return this.query('.navbar-content').innerHTML = templates.includes.navbar.loggedin(app.me);
    }
  });
...
},{"../templates":1,"ampersand-view":31}],10:[function(require,module,exports){
(function() {
  var View;
...
},{"ampersand-view":31}],22:[function(require,module,exports){
(function() {
  var NavbarView, View, ViewSwitcher, templates;
  ...
  module.exports = View.extend({
    ...
    render: function() {
      ...
      this.renderSubview(this.navbar, '.navbar-container');
      return this;
    },
    ...
    handleLinkClick: function(e) {
      var aTag, local;
      aTag = e.target;
      local = aTag.host === window.location.host;
      if (local && !e.ctrlKey && !e.shiftKey && !e.altKey && !e.metaKey) {
        e.preventDefault();
        return app.navigate(aTag.pathname);
      }
    }
  });
...
},{"./navbar.coffee":30,"../templates":1,"ampersand-view-switcher":32,"ampersand-view":31}],32:[function(require,module,exports){
/*$AMPERSAND_VERSION*/
...
require('../../js/tab.js')
require('../../js/affix.js')
},{"../../js/alert.js":33,"../../js/transition.js":34,"../../js/button.js":35,"../../js/collapse.js":36,"../../js/carousel.js":37,"../../js/tooltip.js":38,"../../js/popover.js":39,"../../js/modal.js":40,"../../js/scrollspy.js":41,"../../js/dropdown.js":42,"../../js/tab.js":43,"../../js/affix.js":44}],33:[function(require,module,exports){
/* ========================================================================
...
},{"./ampersand-history":45,"ampersand-class-extend":46,"underscore":47,"backbone-events-standalone":48}],47:[function(require,module,exports){
...
},{"ampersand-state":49,"domify":50,"ampersand-collection-view":51,"underscore":52,"ampersand-dom-bindings":53,"get-object-path":54,"events-mixin":55,"matches-selector":56}],57:[function(require,module,exports){
...
},{"array-next":57,"backbone-events-standalone":59,"key-tree-store":58,"underscore":60}],48:[function(require,module,exports){
module.exports = require('./backbone-events-standalone');

},{"./backbone-events-standalone":61}],45:[function(require,module,exports){
var Events = require('backbone-events-standalone');
var _ = require('underscore');
...
},{"underscore":47,"backbone-events-standalone":48}],60:[function(require,module,exports){
...
},{"extend-object":62}],59:[function(require,module,exports){
module.exports = require('./backbone-events-standalone');

},{"./backbone-events-standalone":63}],27:[function(require,module,exports){
...
},{"ampersand-state":64,"ampersand-sync":65,"underscore":60}],29:[function(require,module,exports){
...
},{"ampersand-collection-rest-mixin":66,"ampersand-collection-underscore-mixin":67,"ampersand-collection":68}],62:[function(require,module,exports){
var arr = [];
...
},{"component-event":69,"delegate-events":70}],71:[function(require,module,exports){
module.exports = function arrayNext(array, currentItem) {
    var len = array.length;
    var newIndex = array.indexOf(currentItem) + 1;
    if (newIndex > (len - 1)) newIndex = 0;
...
},{"ampersand-class-extend":72,"backbone-events-standalone":73,"underscore":52}],74:[function(require,module,exports){
function KeyTreeStore() {
    this.storage = {};
}
...
},{"array-next":71,"key-tree-store":74,"backbone-events-standalone":75,"underscore":52}],76:[function(require,module,exports){
...
},{"underscore":77,"qs":78,"xhr":79}],73:[function(require,module,exports){
module.exports = require('./backbone-events-standalone');

},{"./backbone-events-standalone":80}],53:[function(require,module,exports){
/*$AMPERSAND_VERSION*/
...
},{"key-tree-store":76,"matches-selector":56,"ampersand-dom":81}],75:[function(require,module,exports){
module.exports = require('./backbone-events-standalone');

},{"./backbone-events-standalone":82}],83:[function(require,module,exports){
module.exports = function arrayNext(array, currentItem) {
    var len = array.length;
    var newIndex = array.indexOf(currentItem) + 1;
    if (newIndex > (len - 1)) newIndex = 0;
...
},{"ampersand-class-extend":85,"extend-object":86,"is-array":87,"backbone-events-standalone":88}],72:[function(require,module,exports){
var objectExtend = require('extend-object');
...
},{"extend-object":89}],86:[function(require,module,exports){
var arr = [];
var each = arr.forEach;
var slice = arr.slice;
...
},{"array-next":83,"key-tree-store":84,"backbone-events-standalone":90,"underscore":60}],87:[function(require,module,exports){
...
},{"underscore":60}],90:[function(require,module,exports){
module.exports = require('./backbone-events-standalone');

},{"./backbone-events-standalone":91}],70:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"closest":92,"component-event":93}],89:[function(require,module,exports){
var arr = [];
var each = arr.forEach;
var slice = arr.slice;
...
},{"./lib":94}],66:[function(require,module,exports){
...
},{"ampersand-sync":95,"extend-object":96}],91:[function(require,module,exports){
(function(){/**
 * Standalone extraction of Backbone.Events, no external dependency required.
 * Degrades nicely when Backone/underscore are already available in the current
 * global context.
...
},{"global/window":97,"once":98,"parse-headers":99}],88:[function(require,module,exports){
module.exports = require('./backbone-events-standalone');

},{"./backbone-events-standalone":100}],96:[function(require,module,exports){
var arr = [];
var each = arr.forEach;
var slice = arr.slice;
...
},{"./stringify":101,"./parse":102}],85:[function(require,module,exports){
var objectExtend = require('extend-object');
...
},{"extend-object":86}],103:[function(require,module,exports){
...
},{"__browserify_buffer":103}],92:[function(require,module,exports){
var matches = require('matches-selector')
...
},{"matches-selector":104}],95:[function(require,module,exports){
var _ = require('underscore');
var xhr = require('xhr');
var qs = require('qs');
...
},{"qs":105,"underscore":106,"xhr":107}],104:[function(require,module,exports){
...
},{"trim":108,"for-each":109}],102:[function(require,module,exports){
// Load modules
...
},{"__browserify_buffer":103}],105:[function(require,module,exports){
module.exports = require('./lib');

},{"./lib":111}],112:[function(require,module,exports){
(function(global){if (typeof window !== "undefined") {
    module.exports = window;
} else if (typeof global !== "undefined") {
    module.exports = global;
...
},{"global/window":112,"parse-headers":113,"once":114}],114:[function(require,module,exports){
module.exports = once
...
},{"is-function":115}],111:[function(require,module,exports){
// Load modules
...
},{"./stringify":116,"./parse":117}],115:[function(require,module,exports){
...
},{"__browserify_buffer":103}],113:[function(require,module,exports){
var trim = require('trim')
  , forEach = require('for-each')
  , isArray = function(arg) {
      return Object.prototype.toString.call(arg) === '[object Array]';
...
},{"trim":118,"for-each":119}],117:[function(require,module,exports){
// Load modules
...
},{"__browserify_buffer":103}],119:[function(require,module,exports){
var isFunction = require('is-function')
...
},{"is-function":121}],121:[function(require,module,exports){
module.exports = isFunction
...
},{}]},{},[20,8,5,7,6,4,21,3,9,15,16,11,10,17,12,14,13,18,22,30,1])
;